...
class SelectiveScanCore(torch.autograd.Function):
    ...
    def forward(ctx, u, delta, A, B, C, D=None, delta_bias=None, delta_softplus=False, nrows=1, backnrows=1, oflex=True):
        ...
        # Debugging output to check devices
        # print(f"u.is_cuda: {u.is_cuda}")
        # print(f"delta.is_cuda: {delta.is_cuda}")
        # print(f"A.is_cuda: {A.is_cuda}")
        # print(f"B.is_cuda: {B.is_cuda}")
        # print(f"C.is_cuda: {C.is_cuda}")
        # if D is not None:
        #     print(f"D.is_cuda: {D.is_cuda}")
        # if delta_bias is not None:
        #     print(f"delta_bias.is_cuda: {delta_bias.is_cuda}")
